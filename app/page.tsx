...
export default function HomePage() {
  ...
  /** Speichert einen automatisch generierten Baustein aus dem AutoGenerateDialog */
  const handleSaveAutoGenerated = useCallback(async (tpl: { name: string; content: string; formatting?: any[] }) => {
    if (!username) return;
    try {
  ...
  }, [username, apiFetchWithAuth, currentTemplateField, fetchTemplates]);
  ...
  return (
    <div className="space-y-3 min-h-[calc(100vh-120px)]" onContextMenu={handleContextMenu}>
      ...
      <AutoGenerateDialog
        ...
        apiFetch={apiFetchWithAuth}
        onSaveTemplate={handleSaveAutoGenerated}
      />
    </div>
  );
}
